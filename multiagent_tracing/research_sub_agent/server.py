...
async def invoke_agent(request: Request, invoke_request: InvokeRequest):
    """Invoke the research agent graph with distributed tracing support."""
    try:
        ...
        print(f"Research Agent - Received headers: {parent_headers}")
        ...
        with tracing_context(
            ...
            project_name="research-distributed-traces",  # Always set the project
            replicas=[
